...
export class ProductDetailsComponent {
  ...
  ngOnInit(){
    ...
    //console.log(this.products.find((product) => product.id == this.selected_product_id));
    this.selected_product = this.products.find((product) => product.id == this.selected_product_id);
